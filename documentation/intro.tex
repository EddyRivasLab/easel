...
from the Eddy lab, including HMMER \citep{} and Infernal \citep{}, the
software engines for the Pfam protein family database \citep{} and the
Rfam RNA family database \citep{}.
...
available that do aspire to such goals. The NCBI Toolkit \citep{} and
the Ajax library in EMBOSS \citep{} are particularly comprehensive
resources for C programming, and the BioPerl project is an admirably
successful resource for Perl \citep{}.
...
and source-level comments.\footnote{Too often I've tried to obtain a
...
entire library. \footnote{Too often I've tried to obtain a routine and
found it deeply entangled in a large third-party library. I can either
package the whole library in my software distribution (cumbersome, and
a potential maintainability headache in the long run), or I try to
...
copyright and license notice on the code. \footnote{Too often I've
tried to reuse a routine and been blocked by someone's license
terms. Even some open source licenses, such as the GNU General Public
License (GPL), can impede right-minded developers who happen to use
incompatible open-source licenses. The CC license just provides me
some minimal legal ablative armor in case you like to sue people that

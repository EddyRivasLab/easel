...
implementing some functions. In general, only about a a quarter of
...
The internals of some resizable objects have an \ccode{nredline}
...
resizable object to an extreme allocation size.

At least one module (\ccode{esl\_tree}) allows for creating either a
fixed-size or a resizable object; in this case, there is a
\ccode{\_CreateGrowable()} call for the resizable version.
...
If the object is arbitrarily resizable and it has a \ccode{nredline}

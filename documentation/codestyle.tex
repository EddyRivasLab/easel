...
\ccode{\_root\_} for functions in the \eslmod{rootfinder} module.}  or
...
\ccode{\\ccode\{\}} in the \LaTeX\ documentation. \esldef{Processed}
...
\ccode{\\citep\{MolerVanLoan03\}}, are formatted for the \LaTeX\
\verb+natbib+ package.

...
\newpage
\section{\eslmod{dmatrix}: linear algebra for 2D double matrices}
%\input{../esl_dmatrix}
...
\newpage
\section{\eslmod{keyhash}: keyword hashing, associative array emulation}
\input{../esl_keyhash}
...
\newpage
\section{\eslmod{ssi}: indexing database flatfiles for fast record retrieval}
\input{../esl_ssi}

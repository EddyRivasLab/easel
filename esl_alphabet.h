...
typedef struct {
  ...
  char    *sym;         /* "ACGT-RYMKSWHBVDN*~" , for instance [0..Kp-1]; null-terminated */
...
extern const char  *esl_abc_DecodeType   (int type);
 ...
 */
extern int esl_alphabet_Dump(FILE *fp, const ESL_ALPHABET *a);

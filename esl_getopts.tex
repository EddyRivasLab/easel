...
Input and output filenames can be declared as \ccode{eslARG_INFILE}
and \ccode{eslARG_OUTFILE}, respectively. Currently both are unchecked
types that are treated the same as a \ccode{eslARG_STRING}, except

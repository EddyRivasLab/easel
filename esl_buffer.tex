...
do, but here, \ccode{esl_buffer.c} itself):

\user{gcc -I. -o esl_buffer_example -DeslBUFFER_EXAMPLE esl_buffer.c easel.c -lm}
\user{./esl_buffer_example esl_buffer.c}
...
example), because \ccode{strtok()} tries to write a \ccode{\0} byte
...
\user{gcc -I. -o esl_buffer_example2 -DeslBUFFER_EXAMPLE2 esl_buffer.c easel.c -lm}
\user{./esl_buffer_example2 esl_buffer.c}
\response{Counted 181 x's in 14141 words.}

In the \ccode{esl\_buffer\_GetToken()} call, including \ccode{\r\n}
...
\user{gcc -I. -o esl_buffer_example3 -DeslBUFFER_EXAMPLE3 esl_buffer.c easel.c -lm}
\user{./esl_buffer_example3 esl_buffer.c}
...
\ccode{esl\_buffer\_*} parsing calls as you see appropriate.
...
should include newline characters (\ccode{"\r\n"}) in the separator

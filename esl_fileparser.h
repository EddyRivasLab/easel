...
extern int  esl_fileparser_Open(char *filename, ESL_FILEPARSER **ret_efp);
...
extern int  esl_fileparser_GetTokenOnLine(ESL_FILEPARSER *efp, char **ret_tok, int *ret_toklen);
